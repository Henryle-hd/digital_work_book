    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-sky-100 flex flex-col items-center justify-center p-4">
      {loading ? (
        <div className="flex justify-center items-center space-x-2">
          ...
          <span className="text-lg text-blue-600">paying for u...</span>
        </div>
      ) : (
        <div className="bg-white p-6 rounded-xl shadow-md text-center max-w-lg w-full">
          <h1 className="text-xl lg:text-3xl font-semibold text-blue-600 mb-4">Payment Successful! 🎉</h1>
